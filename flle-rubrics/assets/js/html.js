...
function addELevels(color1,color2,color3,color4) {
    addToBuffer('<td></td><td></td><td bgcolor="'+color1+'" class="rbtd" style="text-align: center;font-weight: bold;">Beginning<br></td><td bgcolor="'+color3+'" class="rbtd" style="text-align: center;font-weight: bold;">Accomplished<br></td><td style="text-align: center;font-weight: bold;" bgcolor="'+color4+'" class="rbtd">Exceeds<br></td>')
}
