...
function specialCasesCheck(mission) {
    ...
    if (mission == "healthUnits2") {
        if (parseInt(document.getElementById("healthUnits1").value) + parseInt(document.getElementById("healthUnits2").value) > 8) {
            document.getElementById("healthUnits1").value = parseInt(document.getElementById("healthUnits1").value) - 1
        ...
        if (parseInt(document.getElementById("healthUnits1").value) + parseInt(document.getElementById("healthUnits2").value) > 8) {
            document.getElementById("healthUnits2").value = parseInt(document.getElementById("healthUnits2").value) - 1
    ...
    if (document.getElementById("yesboccia1").checked) {
        maxCubes = 16
        if (document.getElementById("boccia2").value > maxCubes) {
    ...
    if (mission == "boccia2") {
        ...
        if (parseInt(document.getElementById("bench2").value) + parseInt(document.getElementById("boccia2").value) > maxCubes) {
            document.getElementById("bench2").value = parseInt(document.getElementById("bench2").value) - 1
    ...
    } else if (mission == "bench2") {
        if (parseInt(document.getElementById("bench2").value) + parseInt(document.getElementById("boccia2").value) > maxCubes) {
            document.getElementById("boccia2").value = parseInt(document.getElementById("boccia2").value) - 1
            recalc(window['boccia2' + 'inc'] * parseInt(document.getElementById('boccia2').value), "boccia2", parseInt(document.getElementById('boccia2').value))
        }
    }
...
var load2020 = (function() {
    ...
    createrange("precision1", 10, 0, 6, 6, "M15a", '')
    endtable()
