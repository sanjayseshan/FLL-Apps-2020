...
<label for="'+item1.split(" ")[0]+'">'+item1+'</label>\
    ...
    \
    <label for="'+item4.split(" ")[0]+'">'+item4+'\
            <input class="rbitem" type="checkbox" id="'+item4.split(" ")[0]+'" name="'+item4.split(" ")[0]+'">    </label>\
    \
    </fieldset>    ')
}