...
var load2020CV = (function () {
	...
	addToBuffer("<p>Instructions: The Core Values should be the lens through which you watch the team's presentations. All team members should be demonstrating the Core Values in everything they do. This rubric should be used to record the Core Values observed throughout the judging session.</p><br><br>If the team is a candidate for one of these awards, please tick the appropriate box:")

	addStrengths(
		"Community Impact - A team that has made an amazing impact on their community through their FIRST LEGO League work",
